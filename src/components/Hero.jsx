  ...
  return (
    <div className='w-full h-screen bg-orange-100/80 flex flex-col justify-between font-serif'>
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className='flex flex-col justify-center md:items-start px-4 py-8'>
        ...
        <div className="justify-between">
          <img src={HImg} alt="..." className='rounded-2xl drop-shadow-xl w-[280px] mb-1 float-right' />
          <img src={HImg2} alt="..." className='rounded-2xl drop-shadow-xl w-[260px]' />
        </div>
        <div className="absolute flex flex-col md:min-w-[580px] bottom-[-5%]
