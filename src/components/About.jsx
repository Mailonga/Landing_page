  ...
  return (
    <div className=" w-dull my-15">
      <div className="max-w-[1240px] mx-auto">
        ...
        <div className='grid md:grid-cols-3 text-center font-serif justify-between m-4'>
          <div className='border rounded-xl shadow-xl py-2 m-4 bg-rose-400/10'>
